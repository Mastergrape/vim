" Original protodef.vim by Derek Wyatt
" Edited to use without further need for plugins
...
if !exists('g:protodefprotogetter')
    let g:protodefprotogetter = '~/.vim/plugin/pullproto.pl'
endif
